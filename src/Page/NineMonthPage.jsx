...
const NineMonthPage = () => {
  const clssDes = {
    img: "9.jpg",
    className: " ৯ম শ্রেণি - অনলাইন ব্যাচ ২০২৫",
  };
  ...
  const courses = [
    ...
    },
    {
      ...
      discount: 14500,
      price: 27500,
      link: "https://10minuteschool.com/product/class-9-online-batch-2025/?aff=V2UNK0000ab53&utm_medium=affiliation&utm_source=43859&utm_campaign=null_undefined&utm_content=null&type=affiliate&sku_id=250187&promo=12monthob25",
    },
  ];
  const faqData = [
    {
      title: "'৯ম শ্রেণি - অনলাইন ব্যাচ ২০২৫' কার জন্য",
      content: [
        "বছরের শুরু থেকেই ৯ম শ্রেণির প্রতিটি বিষয়ের ছাত্র-ছাত্রী যারা গোছানো প্রস্তুতি নিতে চায়",
    ...
    {
      title: "'৯ম শ্রেণি - অনলাইন ব্যাচ ২০২৫' তোমাকে কিভাবে প্রস্তুত করবে?",
      content: [
